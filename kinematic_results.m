...
sz = [361 13]
varNames = ["theta2","theta3","R3","R4","R5", "h3","f3","f4","f5", "h3p","f3p","f4p","f5p"]
...
for i=1:361
    ...
    %%writing in "b"
    b2=[-(R2*cos(theta2)-R3*h3^2*cos(theta3)-2*f3*h3*sin(theta3));
    ...
    posData.h3p(i) = x2(1,1);
    posData.f3p(i) = x2(2,1);
    posData.f4p(i) = x2(3,1);
    posData.f5p(i) = x2(4,1);
end
